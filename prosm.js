document.addEventListener('DOMContentLoaded', function () {
    const movieForm = document.getElementById('prosm-movie-form');
    const movieTableBody = document.getElementById('prosm-movie-table').querySelector('tbody');
    const localStorageKey = 'prosmMovies';
